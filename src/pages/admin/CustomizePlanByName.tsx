...
export const CustomizePlanByName = () => {
  ...
  const loadTurmaData = async () => {
    try {
      ...
      setTurmaData({ turma: decodedTurmaNome, alunos: processedAlunos });
  ...
  const toggleFunctionality = async (studentId: string, functionality: string) => {
    ...
    if (error) {
      ...
      toast({ title: "Salvo", description: "Personalização salva com sucesso!" });
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <Button variant="ghost" size="sm" onClick={() => navigate('/admin')} className="text-gray-500 hover:text-primary">
