...
const CorretorCriarSimulado = () => {
  ...
  // Buscar temas publicados para selecionar
  ...
  const temaEscolhido = useMemo(
    () => temas.find(t => t.id === form.tema_id),
    [temas, form.tema_id]
  );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({ title: "Simulado criado!", description: "O simulado foi criado com sucesso." });
        ...
        <div className="overflow-hidden rounded-2xl bg-gradient-to-r from-violet-900 via-violet-700 to-fuchsia-700 p-6 text-white shadow-lg">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-black mt-1">Novo Simulado</h1>
            </div>
            <Button
              variant="ghost"
              size="sm"
...
export default CorretorCriarSimulado;
