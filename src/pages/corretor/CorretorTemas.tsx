          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-xl">{selectedTema.frase_tematica}</CardTitle>
                <Button variant="outline" onClick={() => setSelectedTema(null)}>
                  Voltar
                </Button>
              </div>
              {selectedTema.eixo_tematico && (
                <Badge variant="secondary">{selectedTema.eixo_tematico}</Badge>
              )}
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  redija texto dissertativo-argumentativo em modalidade escrita formal da língua portuguesa sobre o tema "{selectedTema.frase_tematica}", 
