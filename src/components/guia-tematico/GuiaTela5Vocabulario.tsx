...
export function GuiaTela5Vocabulario({ guia, onNext, onBack }: GuiaTela5Props) {
  return (
    <div className="py-8 px-4">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-1">
          <h2 className="text-2xl font-bold text-gray-900">Vocabulário temático</h2>
        </div>

        <ItemListBlock items={guia.vocabulario} />
