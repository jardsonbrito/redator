-- Corrigir completamente a ambiguidade de colunas na função registrar_entrada
...
BEGIN
  ...
  aluno_id := result_record.aluno_id;
  aula_id := result_record.aula_id;
  entrada_at := result_record.entrada_at;
  saida_at := result_record.saida_at;
  
  RETURN NEXT;
END;
$$;

-- Corrigir função registrar_saida da mesma forma
