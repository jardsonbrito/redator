-- Adicionar suporte para redações do processo seletivo na função get_student_redacoes_com_status_finalizado

-- Dropar a função existente primeiro (necessário pois o RETURNS TABLE mudou)
