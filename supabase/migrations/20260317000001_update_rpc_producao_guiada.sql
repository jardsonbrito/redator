-- Atualizar RPC get_redacoes_corretor_detalhadas para expor exercicio_tipo
-- Necessário para a bifurcação do formulário de correção (Produção Guiada vs. padrão)
...
RETURNS TABLE(
  ...
  corretor_id_2           uuid,
  turma                   text,
  exercicio_tipo          text    -- NULL para regular/simulado; e.tipo para exercício
)
LANGUAGE sql
