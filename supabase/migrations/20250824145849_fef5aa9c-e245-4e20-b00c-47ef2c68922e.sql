...
DROP POLICY IF EXISTS "Admin only access presenca_aulas_backup" ON public.presenca_aulas_backup;
DROP POLICY IF EXISTS "Admin only access rpc_log" ON public.rpc_log;
