-- Restaurar TODAS as funções RPC ao estado original com redacoes_exercicio
-- Esta migração reverte as alterações acidentais feitas em produção

-- 1. Restaurar get_redacoes_corretor_detalhadas
