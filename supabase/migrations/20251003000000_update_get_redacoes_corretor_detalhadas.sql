-- Migration: Atualizar função get_redacoes_corretor_detalhadas para incluir redacao_imagem_gerada_url
-- Data: 2025-10-03
-- Descrição: Adiciona o campo redacao_imagem_gerada_url ao retorno da função RPC
